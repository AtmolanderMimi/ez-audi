use cpal::{
    SampleFormat, SampleRate, SupportedBufferSize, SupportedOutputConfigs, SupportedStreamConfig,
...
pub fn best_fitting_stream_config(
    config: &SupportedStreamConfig,
    range: SupportedOutputConfigs,
...
pub fn new_supported_stream_config(
    channels: u16,
    sample_rate: u32,
